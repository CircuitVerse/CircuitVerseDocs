...
<OptimizedImage
  src="/img/img_chapter6/6.2.png"
  alt="Description of different icons available on the Timing Diagram panel"
  caption="Figure 6.2: Description of different icons available on the Timing Diagram panel"
/>
...
<OptimizedImage
  src="/img/img_chapter6/6.3.png"
  alt="Circuit design where two NOT gates cancel out each other to behave as an XNOR gate"
  caption="Figure 6.3: Circuit design where two NOT gates cancel out each other to behave as an XNOR gate"
/>
