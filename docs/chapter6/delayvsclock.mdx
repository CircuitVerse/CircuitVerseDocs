...
<OptimizedImage
  src="/img/img_chapter6/6.1.png"
  alt="The Clock Time(ms) property attribute is the time interval for the half cycle of a circuit"
  caption="Figure 6.1: The Clock Time(ms) property attribute is the time interval for the half cycle of a circuit"
/>
