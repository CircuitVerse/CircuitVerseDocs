...
2. Click on the **Launch Simulator** button to launch the simulator. Refer Figure 7.1.
  ...
  <OptimizedImage
    src="/img/img_chapter7/7.1.png"
    alt="Launch CircuitVerse simulator from the CircuitVerse homepage"
    caption="Figure 7.1: Launch CircuitVerse simulator from the CircuitVerse homepage"
  />
...
3. Navigate to the **Quick Access Panel**. Click on either **Save Online** icon or **Save Offline** icon to receive the **Enter Project Name** : pop-up window for saving the circuit. Refer Figure 7.2.
   ...
   <div align="center">
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.2.png"
      alt="Save CircuitVerse project online or offline from the Quick Access Panel"
      caption="Figure 7.2: Save CircuitVerse project online or offline from the Quick Access Panel"
    />
...
4. If the project is saved online, you will be directed to the **Edit Project** details page for sharing more information about the project (refer Figure 7.3).
   ...
   <div align="center">
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.3.png"
      alt="Edit CircuitVerse project details page for sharing more information about the project"
      caption="Figure 7.3: Edit CircuitVerse project details page for sharing more information about the project"
    />
  ...
  <div style={{display: "flex", justifyContent: "center"}}>
    <iframe style={{width: "75%", aspectRatio: "16/9"}} src="https://www.youtube.com/embed/b4SXde9huFQ?si=9Y9noFw90boEGfP_" title="YouTube video: Saving Projects Within the CircuitVerse Simulator" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
  </div>
...
5. Click **Update Project** to save the project details and return back to the CV simulator window. Refer Figure 7.4.
   ...
   <div align="center">
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.4.png"
      alt="Update CircuitVerse project details and return back to the simulator window"
      caption="Figure 7.4: Update CircuitVerse project details and return back to the simulator window"
    />
...
6. Navigate to the **CIRCUITS ELEMENTS** panel. Identify the relevant circuit elements and drop them on the canvas. If required, you may search for an element in the search bar. Refer Figure 7.5.
   ...
   <div align="center">
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.5.png"
      alt="Building a half adder circuit using different circuit elements within CircuitVerse simulator"
      caption="Figure 7.5: Building a half adder circuit using different circuit elements within CircuitVerse simulator"
    />
...
7. Connect the circuit elements by clicking on one node and dragging the mouse to the other node. Refer to Figure 7.6 for the final circuit connection.
   ...
   <div align="center">
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.6.png"
      alt="Completed half adder circuit within CircuitVerse simulator"
      caption="Figure 7.6: Completed half adder circuit within CircuitVerse simulator"
    />
...
9. Navigate to the **PROPERTIES** panel. Edit the **Label** parameter to add a label for the selected circuit element. Refer Figure 7.7.
   ...
   <div align="center">
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.7.png"
      alt="Adding labels to different circuit elements using the PROPERTIES panel"
      caption="Figure 7.7: Adding labels to different circuit elements using the PROPERTIES panel"
    />
...
12. Click on the **Edit Layout** button to display the circuit layout for the built circuit (refer Figure 7.8).
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.8.png"
      alt="Accessing Edit Layout from the PROPERTIES panel"
      caption="Figure 7.8: Accessing Edit Layout from the PROPERTIES panel"
    />
...
13. The **Edit Layout** screen displays the page as shown in Figure 7.9. The circuit is placed inside a back box. The **LAYOUT** panel displays different options for editing the layout of the circuit.
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.9.png"
      alt="Circuit layout displayed within the Edit Layout screen"
      caption="Figure 7.9: Circuit layout displayed within the Edit Layout screen"
    />
...
15. Click **Save** to save the layout settings as shown in Figure 7.10.
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.10.png"
      alt="Save circuit layout settings from the Edit Layout screen"
      caption="Figure 7.10: Save circuit layout settings from the Edit Layout screen"
    />
...
16. Click on the add tab icon (refer Figure 7.11) displayed in the circuit tab section. Alternatively, you may also click on **NewCircuit+** selection in the **Circuit** drop-down menu. As shown in Figure 7.11, the **Enter circuit name:** pop up window is displayed.
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.11.png"
      alt="Add new circuit tab from the circuit tab section"
      caption="Figure 7.11: Add new circuit tab from the circuit tab section"
    />
...
18. Click **OK** to save the circuit name. Refer Figure 7.12.
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.12.png"
      alt="New circuit tab created for building full adder circuit"
      caption="Figure 7.12: New circuit tab created for building full adder circuit"
    />
...
<OptimizedImage
  src="/img/img_chapter7/7.13.png"
  alt="Insert SubCircuit from the Circuit drop-down menu"
  caption="Figure 7.13: Insert SubCircuit from the Circuit drop-down menu"
/>
...
<OptimizedImage
  src="/img/img_chapter7/7.14.png"
  alt="Select the desired subcircuit to insert within the current circuit tab"
  caption="Figure 7.14: Select the desired subcircuit to insert within the current circuit tab"
/>
...
23. Refer to Figure 7.15 and complete the wiring connections of the full adder circuit.
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.15.png"
      alt="Completed full adder circuit using two half adder subcircuits"
      caption="Figure 7.15: Completed full adder circuit using two half adder subcircuits"
    />
...
1. Navigate to **Circuit** drop-down menu to select **New Verilog Module** from the drop down menu. As shown in Figure 7.16, the **Enter circuit name** pop up window is displayed.
   ...
   <div align="center">
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.16.png"
      alt="Create new Verilog module from the Circuit drop-down menu"
      caption="Figure 7.16: Create new Verilog module from the Circuit drop-down menu"
    />
...
3. Click **OK** to launch the Verilog code interface window as shown in Figure 7.17.
   ...
   <div align="center">
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.17.png"
      alt="Verilog code interface window for adding Verilog code"
      caption="Figure 7.17: Verilog code interface window for adding Verilog code"
    />
...
4. Enter the desired Verilog code in the module interface. Refer Figure 7.18.
   ...
   <div align="center">
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.18.png"
      alt="Adding Verilog code in the module interface"
      caption="Figure 7.18: Adding Verilog code in the module interface"
    />
...
5. Click on the **Save Code** button to receive the message that the code has been saved successfully. Refer Figure 7.19.
   ...
   <div align="center">
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.19.png"
      alt="Save Verilog code from the module interface"
      caption="Figure 7.19: Save Verilog code from the module interface"
    />
...
24. Navigate to the **Misc** section of the **CIRCUIT ELEMENTS** panel as shown in Figure 7.20.
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.20.png"
      alt="Misc section of the CIRCUIT ELEMENTS panel for adding annotation elements"
      caption="Figure 7.20: Misc section of the CIRCUIT ELEMENTS panel for adding annotation elements"
    />
...
25. Drag the **Text Tool** element on the canvas as shown in Figure 7.21.
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.21.png"
      alt="Adding Text Tool element for annotating the circuit"
      caption="Figure 7.21: Adding Text Tool element for annotating the circuit"
    />
...
27. Repeat steps 24 to 26 to add more annotation elements. In Figure 7.22, a **Rectangle Tool** element has been added to highlight the structural relationship across different elements .
    ...
    <OptimizedImage
      src="/img/img_chapter7/7.22.png"
      alt="Adding Rectangle Tool element for annotating the circuit"
      caption="Figure 7.22: Adding Rectangle Tool element for annotating the circuit"
    />