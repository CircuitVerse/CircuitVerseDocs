...
4. If the project is saved online, you will be directed to the **Edit Project** details page for sharing more information about the project (refer Figure 7.3).
   ...
   <div><iframe style="width:100%; aspect-ratio:16/9;" src="https://www.youtube.com/embed/b4SXde9huFQ?si=9Y9noFw90boEGfP_" title="YouTube video: Saving Projects Within the CircuitVerse Simulator" frameborder="0"
