...
<OptimizedImage
  src="/img/img_chapter5/5.3.png"
  alt="Using Edit Layout to manage circuit layouts in CircuitVerse simulator"
  caption="Figure 5.3: Using Edit Layout to manage circuit layouts in CircuitVerse simulator"
/>
