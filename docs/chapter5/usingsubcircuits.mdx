...
<OptimizedImage
  src="/img/img_chapter5/5.1.png"
  alt="Ideal circuit design flow for an integrated effort while using subcircuits within CircuitVerse"
  caption="Figure 5.1: Ideal circuit design flow for an integrated effort while using subcircuits within CircuitVerse"
/>
...
<OptimizedImage
  src="/img/img_chapter5/5.2.png"
  alt="Add Verilog code to generate the circuit layout"
  caption="Figure 5.2: Add Verilog code to generate the circuit layout"
/>