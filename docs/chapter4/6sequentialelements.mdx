...
<OptimizedImage
  src="/img/img_chapter4/4.3-removebg-preview.png"
  alt="Figure 4.3: Pin description of the D Flip Flop within the CircuitVerse platform"
  caption="Figure 4.3: Pin description of the D Flip Flop within the CircuitVerse platform"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.4-removebg-preview.png"
  alt="Figure 4.4: Pin description of the D Latch within the CircuitVerse platform"
  caption="Figure 4.4: Pin description of the D Latch within the CircuitVerse platform"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.5-removebg-preview.png"
  alt="Figure 4.5: Pin description of the T Flip Flop within the CircuitVerse platform"
  caption="Figure 4.5: Pin description of the T Flip Flop within the CircuitVerse platform"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.6-removebg-preview.png"
  alt="Figure 4.6: Pin description of the SR Flip Flop within the CircuitVerse platform"
  caption="Figure 4.6: Pin description of the SR Flip Flop within the CircuitVerse platform"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.7-removebg-preview.png"
  alt="Figure 4.7: Pin description of the JK Flip Flop within the CircuitVerse platform"
  caption="Figure 4.7: Pin description of the JK Flip Flop within the CircuitVerse platform"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.8-removebg-preview.png"
  alt="Figure 4.8: Pin description of the TTY circuit element within the CircuitVerse platform"
  caption="Figure 4.8: Pin description of the TTY circuit element within the CircuitVerse platform"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.9-removebg-preview.png"
  alt="Figure 4.9: Pin description of the Keyboard circuit element within the CircuitVerse platform"
  caption="Figure 4.9: Pin description of the Keyboard circuit element within the CircuitVerse platform"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.10-removebg-preview.png"
  alt="Figure 4.10: ROM circuit element within the CircuitVerse platform"
  caption="Figure 4.10: ROM circuit element within the CircuitVerse platform"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.11-removebg-preview.png"
  alt="Figure 4.11: RAM circuit element and relevant property attributes available in the PROPERTIES panel"
  caption="Figure 4.11: RAM circuit element and relevant property attributes available in the PROPERTIES panel"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.12-removebg-preview.png"
  alt="Figure 4.12: EEPROM circuit element available within the CircuitVerse simulator"
  caption="Figure 4.12: EEPROM circuit element available within the CircuitVerse simulator"
/>
