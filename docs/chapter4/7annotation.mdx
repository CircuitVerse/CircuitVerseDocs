...
<OptimizedImage
  src="/img/img_chapter4/4.13.png"
  alt="Figure 4.13: Add labels for individually describing the relevant circuit element on the Canvas"
  caption="Figure 4.13: Add labels for individually describing the relevant circuit element on the Canvas"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.14-removebg-preview.png"
  alt="Figure 4.14: Live circuit annotation using different annotation elements available within CircuitVerse"
  caption="Figure 4.14: Live circuit annotation using different annotation elements available within CircuitVerse"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.15.png"
  alt="Figure 4.15: Relevant attributes for the Arrow annotation element"
  caption="Figure 4.15: Relevant attributes for the Arrow annotation element"
/>
...
<OptimizedImage
  src="/img/img_chapter4/4.16.png"
  alt="Figure 4.16: Relevant attributes for the ImageAnnotation annotation element"
  caption="Figure 4.16: Relevant attributes for the ImageAnnotation annotation element"
/>
