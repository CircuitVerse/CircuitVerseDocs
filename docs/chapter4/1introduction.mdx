...
<OptimizedImage
  src="/img/img_chapter4/4.1.png"
  alt="Different circuit elements are available within the CV simulator for building circuits"
  caption="Figure 4.1: Different circuit elements are available within the CV simulator for building circuits"
/>
...
2. [Output](3output.mdx)
3. [Gates](4gates.md)
4. [Decoders & Plexers](5muxandplex.md)
5. [Sequential Elements](6sequentialelements.mdx)
6. [Annotation](7annotation.mdx)
7. [Misc](8misc.mdx)
