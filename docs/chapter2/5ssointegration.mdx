...
<OptimizedImage
    src="/img/img_chapter2/sso_integration/about_sso.png"
    alt="About SSO Integration"
    caption="Figure 2.60: About SSO Integration"
/>
...
2. Navigate to "Applications" > "Applications" in the main menu.
   ...
   <OptimizedImage
       src="/img/img_chapter2/sso_integration/navigate_to_applicattion.png"
       alt="Navigate to Applications"
       caption="Figure 2.61: Navigate to Applications"
   />
...
3. Click on "Create App Integration".
   ...
   <OptimizedImage
       src="/img/img_chapter2/sso_integration/create_app_integration.png"
       alt="Create App Integration"
       caption="Figure 2.62: Create App Integration"
   />
...
4. Select "SAML 2.0" as the Sign-on method and click "Next".
   ...
   <OptimizedImage
       src="/img/img_chapter2/sso_integration/step_4_select_saml2.0.png"
       alt="Select SAML 2.0"
       caption="Figure 2.63: Select SAML 2.0"
   />
...
5. Fill in the following details for your CircuitVerse app:
   ...
   <OptimizedImage
       src="/img/img_chapter2/sso_integration/step5.png"
       alt="Add name and logo"
       caption="Figure 2.64: Add name and logo"
   />
...
6. In the "SAML Settings" section, configure the following:
   ...
   <OptimizedImage
       src="/img/img_chapter2/sso_integration/step6.png"
       alt="SAML Settings"
       caption="Figure 2.65: SAML Settings"
   />
...
7. Click "Next" and select "I'm an Okta customer adding an internal app".
   ...
   <OptimizedImage
       src="/img/img_chapter2/sso_integration/step7.png"
       alt="Select internal app"
       caption="Figure 2.66: Select internal app"
   />
...
9. In the "Sign On" tab of your new application, find the "Identity Provider metadata" or "View Setup Instructions" to obtain the following information:
   ...
   <OptimizedImage
      src="/img/img_chapter2/sso_integration/credentials.png"
      alt="Credentials"
      maxWidth={400}
      caption="Figure 2.67: Credentials"
   />
...
10. You can add users and groups by navigate to Assignment > Assign > Assign to People / Assign to Groups
    ...
    <!-- ![Assign people/Groups](/img/img_chapter2/sso_integration/Assign.png) -->
      <OptimizedImage
         src="/img/img_chapter2/sso_integration/Assign.png"
         alt="Assign people/Groups"
         caption="Figure 2.68: Assign people/Groups"
      />
...
<OptimizedImage
    src="/img/img_chapter2/sso_integration/SingleSignOnButton.png"
    alt="Single Sign On Button"
    caption="Figure 2.69: Single Sign On Button"
/>
...
1. Go to the Keycloak Admin console UI and sign in as an administrator
   ...
   <OptimizedImage
       src="/img/img_chapter2/sso_integration/admin-login-keycloak.webp"
       alt="Keycloak Admin console"
       caption="Figure 2.70: Keycloak Admin console"
   />
...
3. In the left sidebar, click on "Clients" and then click "Create" to add a new client.
   ...
   - Client Type: Select `SAML`
     ...
     <!-- ![create a realm for CircuitVerse.](/img/img_chapter2/sso_integration/create-realm-keycloak.png) -->
       <OptimizedImage
          src="/img/img_chapter2/sso_integration/create-realm-keycloak.png"
          alt="Create Realm for CircuitVerse"
          caption="Figure 2.71: Create Realm for CircuitVerse"
      />
...
4. Click "Save" to create the client.
   ...
   <OptimizedImage
       src="/img/img_chapter2/sso_integration/create-client-keycloak.png"
       alt="Create Client Keycloak"
       caption="Figure 2.72: Create Client Keycloak"
   />
...
5. In the client settings, configure the following:
   ...
   - Master SAML Processing URL: https://your-circuitverse-domain.com/users/saml/auth
     ...
     <!-- ![Configurations Details](/img/img_chapter2/sso_integration/client-access-settings-keycloak.png) -->
      ...
      <OptimizedImage
         src="/img/img_chapter2/sso_integration/client-access-settings-keycloak.png"
         alt="Configurations Details"
         caption="Figure 2.73: Configurations Details"
      />
...
7. Go to Clients > Keys, and turn off the Client signature required option from signing keys config
   ...
   <OptimizedImage
       src="/img/img_chapter2/sso_integration/client-signature-required.png"
       alt="Client Signature Required"
       caption="Figure 2.74: Client Signature Required"
   />
...
8. Create new user which is to be used for login. Be sure to include email id in username and email fields
   ...
   <OptimizedImage
       src="/img/img_chapter2/sso_integration/create-user.webp"
       alt="Create User"
       caption="Figure 2.75: Create User"
   />
...
<OptimizedImage
    src="/img/img_chapter2/sso_integration/SingleSignOnButton.png"
    alt="Single Sign On Button"
    caption="Figure 2.76: Single Sign On Button"
/>
