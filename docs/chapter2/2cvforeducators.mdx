...
title: "CircuitVerse for Educators"
description: "CircuitVerse for Educators page in Chapter 2 of CircuitVerse documentation."
---
...
<OptimizedImage
  src="/img/img_chapter2/2.2.png"
  alt="Figure 2.2: CircuitVerse workflow for managing student groups and assignments"
  caption="Figure 2.2: CircuitVerse workflow for managing student groups and assignments"
/>
...
1. Navigate to your account displayed in the upper right-hand corner of your screen. (Refer to Figure 2.3)
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.3.png"
     alt="Figure 2.3"
     caption="Figure 2.3: Options in the upper right-hand corner of the CircuitVerse portal"
   />
...
2. Click on **My Groups** to display the GROUPS page as shown in Figure 2.4.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.4.png"
     alt="Figure 2.4"
     caption="Figure 2.4: Groups page listing different groups associated with the user"
   />
...
3. Click on the **+Make New Group** button to display the **NEW GROUP:** page. Refer to Figure 2.5.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.5.png"
     alt="Figure 2.5"
     caption="Figure 2.5: New Group page for creating a new group"
   />
...
4. Enter a name for your new group in the **Group Name:** text field. Refer to Figure 2.6.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.6.png"
     alt="Figure 2.6"
     caption="Figure 2.6: Entering a name for the new group"
   />
...
5. Click **Save** to complete the process. Refer to Figure 2.7.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.7.png"
     alt="Figure 2.7"
     caption="Figure 2.7: Saving the new group"
   />
...
6. Once a new group is successfully created, a successful group creation message (as shown in Figure 2.8) is displayed on the **GROUPS** page.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.8.png"
     alt="Figure 2.8"
     caption="Figure 2.8: Successful group creation message"
   />
...
1. Navigate to **Login** displayed in the upper right-hand corner of your screen and log in to the portal. (Refer to Figure 2.9)
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.3.png"
     alt="Figure 2.9"
     caption="Figure 2.9: Login options in the upper right-hand corner of the CircuitVerse portal"
   />
...
2. Click on **My Groups** to display the GROUPS page as shown in Figure 2.10. This page lists the different groups you are associated with.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.4.png"
     alt="Figure 2.10"
     caption="Figure 2.10: Groups page listing different groups associated with the user"
   />
...
3. Select the group to which you wish to add your mentors and click on the **View** icon (refer to Figure 2.11) to display the next page for adding members and assignments.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.11.png"
     alt="Figure 2.11"
     caption="Figure 2.11: Viewing the selected group for adding mentors"
   />
...
4. Click on the **+Add Mentors** button to add mentors to the selected group. An **Add Mentors** pop-up window is displayed (refer to Figure 2.11.1).
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.58.png"
     alt="Figure 2.11.1"
     caption="Figure 2.11.1: Add Mentors pop-up window for adding mentors to the selected group"
   />
...
5. Enter email IDs separated by commas, spaces, or list them individually in separate lines in the **Email IDs:** text field box. Refer to Figure 2.11.2.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.59.png"
     alt="Figure 2.11.2"
     caption="Figure 2.11.2: Entering email IDs of mentors to be added to the selected group"
   />
...
6. Click on **Add mentors** to complete the process. Refer to Figure 2.11.3.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.60.png"
     alt="Figure 2.11.3"
     caption="Figure 2.11.3: Adding mentors to the selected group"
   />
...
7. The group mentors will be listed in the **MENTORS** section. Refer to Figure 2.11.4.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.61.png"
     alt="Figure 2.11.4"
     caption="Figure 2.11.4: Listing of group mentors in the MENTORS section"
   />
...
4. Click on the **+Add Members** button to add members to the selected group. An **Add Members** pop-up window is displayed (refer to Figure 2.12).
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.12.png"
     alt="Figure 2.12: Add Members pop-up window for adding members to the selected group"
     caption="Figure 2.12: Add Members pop-up window for adding members to the selected group"
   />
...
5. Enter email IDs separated by commas, spaces, or list them individually in separate lines in the **Email IDs:** text field box. Refer to Figure 2.13.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.13.png"
     alt="Figure 2.13: Entering email IDs of members to be added to the selected group"
     caption="Figure 2.13: Entering email IDs of members to be added to the selected group"
   />
...
6. Click on **Add members** to complete the process. Refer to Figure 2.14.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.14.png"
     alt="Figure 2.14: Adding members to the selected group"
     caption="Figure 2.14: Adding members to the selected group"
   />
...
7. The group members will be listed in the **MEMBERS** section. Refer to Figure 2.15.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.15.png"
     alt="Figure 2.15: Listing of group members in the MEMBERS section"
     caption="Figure 2.15: Listing of group members in the MEMBERS section"
   />
...
<OptimizedImage
  src="/img/img_chapter2/2.16.png"
  alt="Figure 2.16: Email invitation received by students to register with CircuitVerse"
  caption="Figure 2.16: Email invitation received by students to register with CircuitVerse"
/>
...
1. All members are listed under the **MEMBERS** section.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.62.png"
     alt="Listing of group members in the MEMBERS section"
     caption="Figure 2.15.1: Listing of group members in the MEMBERS section"
   />
...
2. Click on the **Make mentor** button in the desired member's container.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.63.png"
     alt="Make mentor button for switching member to mentor"
     caption="Figure 2.15.2: Make mentor button for switching member to mentor"
   />
...
3. A popup will be displayed for confirmation; you can check the mentor accessibilities.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.64.png"
     alt="Confirmation popup for switching member to mentor"
     caption="Figure 2.15.3: Confirmation popup for switching member to mentor"
   />
...
4. Click on **Make mentor** and you're all done!
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.65.png"
     alt="Successful role switch from member to mentor"
     caption="Figure 2.15.4: Successful role switch from member to mentor"
   />
...
1. All mentors are listed under the **MENTORS** section.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.66.png"
     alt="Listing of group mentors in the MENTORS section"
     caption="Figure 2.15.5: Listing of group mentors in the MENTORS section"
   />
...
2. Click on the **Make member** button in the desired mentor's container.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.67.png"
     alt="Make member button for switching mentor to member"
     caption="Figure 2.15.6: Make member button for switching mentor to member"
   />
3. A popup will be displayed for confirmation; you can check the member accessibilities.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.68.png"
     alt="Confirmation popup for switching mentor to member"
     caption="Figure 2.15.7: Confirmation popup for switching mentor to member"
   />
...
4. Click on **Make member** and you're all done!
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.69.png"
     alt="Successful role switch from mentor to member"
     caption="Figure 2.15.8: Successful role switch from mentor to member"
   />
...
1. Navigate to your account displayed in the upper right-hand corner of your screen. Refer to Figure 2.17.
   ...
   <OptimizedImage
      src="/img/img_chapter2/2.3.png"
      alt="Figure 2.17: Login options in the upper right-hand corner of the CircuitVerse portal"
      caption="Figure 2.17: Login options in the upper right-hand corner of the CircuitVerse portal"
   />
...
2. Click on **My Groups** to display the GROUPS page as shown in Figure 2.18. This page lists the different groups you are associated with.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.4.png"
     alt="Figure 2.18: Groups page listing different groups associated with the user"
     caption="Figure 2.18: Groups page listing different groups associated with the user"
   />
...
3. Select the group to which you wish to add assignments and click on the **View** icon (refer to Figure 2.19) to display the next page for adding members and assignments.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.19.png"
     alt="Figure 2.19: Viewing the selected group for adding assignments"
     caption="Figure 2.19: Viewing the selected group for adding assignments"
   />
...
4. Navigate to the **Assignments** section and click on the **+Add Assignment** button to display the **New Assignment** page as shown in Figure 2.20.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.20.png"
     alt="Figure 2.20: New Assignment page for adding a new assignment to the selected group"
     caption="Figure 2.20: New Assignment page for adding a new assignment to the selected group"
   />
...
5. Enter a name for the assignment in the **Name** text field as shown in Figure 2.21.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.21.png"
     alt="Figure 2.21: Entering a name for the new assignment"
     caption="Figure 2.21: Entering a name for the new assignment"
   />
...
6. Enter a brief description of the assignment in the **Description** text field as shown in Figure 2.22.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.22.png"
     alt="Figure 2.22: Entering a brief description for the new assignment"
     caption="Figure 2.22: Entering a brief description for the new assignment"
   />
...
7. Enter a timestamp for the assignment deadline in the **Deadline** text field as shown in Figure 2.23.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.23.png"
     alt="Figure 2.23: Entering a timestamp for the assignment deadline"
     caption="Figure 2.23: Entering a timestamp for the assignment deadline"
   />
...
8. Choose a grading scale from the **Grading scale** drop-down menu as shown in Figure 2.24. Refer to Table 2.2 for a brief description of the different grading scales available within the CircuitVerse simulator.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.24.png"
     alt="Figure 2.24: Grading scale drop-down menu for selecting a grading scale"
     caption="Figure 2.24: Grading scale drop-down menu for selecting a grading scale"
   />
...
9. If needed, click the **Enable Elements Restriction** toggle button to display the list of elements that will be disabled for group members working on the assignments. Refer to Figure 2.25.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.25.png"
     alt="Figure 2.25: Enabling element restrictions for the new assignment"
     caption="Figure 2.25: Enabling element restrictions for the new assignment"
   />
...
10. Click the **Create Assignment** button to complete the process (refer to Figure 2.26). The new assignment will be listed under the **ASSIGNMENTS** section.
    ...
    <div align="center"><em>Figure 2.26</em></div> -->
      ...
      <OptimizedImage
         src="/img/img_chapter2/2.26.png"
         alt="Figure 2.26: Creating the new assignment"
         caption="Figure 2.26: Creating the new assignment"
      />
    ...
    <div align="center"><em>Figure 2.27</em></div> -->
      ...
      <OptimizedImage
         src="/img/img_chapter2/2.27.png"
         alt="Figure 2.27: Different tasks for managing assignments"
         caption="Figure 2.27: Different tasks for managing assignments"
      />
...
<OptimizedImage
  src="/img/img_chapter2/2.24.png"
  alt="Figure 2.28: Grading criteria drop-down menu for selecting a grading criteria"
  caption="Figure 2.28: Grading criteria drop-down menu for selecting a grading criteria"
/>
...
1. Click on **My Groups** to display the GROUPS page as shown in Figure 2.29. This page lists the different groups you are associated with.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.4.png"
     alt="Figure 2.29: Groups page listing different groups associated with the user"
     caption="Figure 2.29: Groups page listing different groups associated with the user"
   />
...
2. Select the group to which you wish to add assignments and click on the **View** icon (refer to Figure 2.30) to display the next page for viewing your members and assignments.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.30.png"
     alt="Figure 2.30: Viewing the selected group for grading assignments"
     caption="Figure 2.30: Viewing the selected group for grading assignments"
   />
...
3. Navigate to the **Assignments** section to view the list of assignments available for the selected group. Refer to Figure 2.31.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.31.png"
     alt="Figure 2.31: List of assignments available for the selected group"
     caption="Figure 2.31: List of assignments available for the selected group"
   />
...
4. Select the assignment that must be graded. Refer to Figure 2.32.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.32.png"
     alt="Figure 2.32: Selecting the assignment to be graded"
     caption="Figure 2.32: Selecting the assignment to be graded"
   />
...
5. Click on **View** to launch the assignment details page. Refer to Figure 2.33.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.33.png"
     alt="Figure 2.33: Assignment details page for grading the selected assignment"
     caption="Figure 2.33: Assignment details page for grading the selected assignment"
   />
...
6. Navigate to the **Submissions** section of the page to view the different submissions from the group members. Refer to Figure 2.34.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.34.png"
     alt="Figure 2.34: Submissions section for viewing different submissions from group members"
     caption="Figure 2.34: Submissions section for viewing different submissions from group members"
   />
...
7. Select a submission from the left-hand side of the member list and double-click on the selection to view the submitted circuit (see Figure 2.35).
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.35.png"
     alt="Figure 2.35: Viewing the submitted circuit for grading"
     caption="Figure 2.35: Viewing the submitted circuit for grading"
   />
...
8. Enter the desired grade in the **Grade** text field. If needed, add remarks. Refer to Figure 2.36.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.36.png"
     alt="Figure 2.36: Entering the grade and remarks for the selected student submission"
     caption="Figure 2.36: Entering the grade and remarks for the selected student submission"
   />
...
9. Click on the **Submit** button (refer to Figure 2.37) to add or update the grade for the selected student for the relevant assignment.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.37.png"
     alt="Figure 2.37: Submitting the grade for the selected student submission"
     caption="Figure 2.37: Submitting the grade for the selected student submission"
   />
...
1. Navigate to the student group for which the grades must be exported and click **View** to display the next page for viewing your members and assignments. Refer to Figure 2.38.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.38.png"
     alt="Figure 2.38: Viewing the selected group for exporting grades"
     caption="Figure 2.38: Viewing the selected group for exporting grades"
   />
...
2. Navigate to the **Assignments** section to view the list of assignments available for the selected group. Refer to Figure 2.39.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.31.png"
     alt="Figure 2.39: List of assignments available for the selected group"
     caption="Figure 2.39: List of assignments available for the selected group"
   />
...
3. Select the assignment that must be graded. Refer to Figure 2.40.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.32.png"
     alt="Figure 2.40: Selecting the assignment to be graded"
     caption="Figure 2.40: Selecting the assignment to be graded"
   />
...
4. Click on **View** to launch the assignment details page. Refer to Figure 2.41.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.41.png"
     alt="Figure 2.41: Assignment details page for exporting grades of the selected assignment"
     caption="Figure 2.41: Assignment details page for exporting grades of the selected assignment"
   />
...
5. Scroll down on the assignment details page and click on the **Export Grades** button to export the grades into a .csv file on your machine. Refer to Figure 2.43.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.43.png"
     alt="Figure 2.43: Exporting grades for the selected assignment"
     caption="Figure 2.43: Exporting grades for the selected assignment"
   />
...
<OptimizedImage
  src="/img/img_chapter2/2.44.png"
  alt="Figure 2.44: Setting the Project access type to Public for embedding the CircuitVerse simulation"
  caption="Figure 2.44: Setting the Project access type to Public for embedding the CircuitVerse simulation"
/>
...
1. Navigate to your account displayed in the upper right-hand corner of your screen. Select **Dashboard** from the drop-down menu to display your dashboard. Refer to Figure 2.45.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.45.png"
     alt="Figure 2.45: Navigating to the user dashboard from the account menu"
     caption="Figure 2.45: Navigating to the user dashboard from the account menu"
   />
...
2. Navigate to the project that you wish to embed. Refer to Figure 2.46.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.46.png"
     alt="Figure 2.46: Selecting the project to be embedded from the user dashboard"
     caption="Figure 2.46: Selecting the project to be embedded from the user dashboard"
   />
...
3. Click on the **More** button to display the project details page. Refer to Figure 2.47.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.47.png"
     alt="Figure 2.47: Accessing the project details page for the selected project"
     caption="Figure 2.47: Accessing the project details page for the selected project"
   />
...
4. Click on the **Embed** button to display the popup to customize the iframe associated with the relevant project. Refer to Figure 2.48.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.48.png"
     alt="Figure 2.48: Embedding the selected project"
     caption="Figure 2.48: Embedding the selected project"
   />
...
5. Customize your project embed in the popup. You can customize height, width, border-width, border-color, and border-style. Refer to Figure 2.48.1.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.48.1.png"
     alt="Figure 2.48.1: Customizing the project embed options"
     caption="Figure 2.48.1: Customizing the project embed options"
   />
...
6. For the advanced options, click on the **Advanced Option** and more options will be rendered. Refer to Figure 2.48.2.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.48.2.png"
     alt="Figure 2.48.2: Accessing advanced options for customizing the project embed"
     caption="Figure 2.48.2: Accessing advanced options for customizing the project embed"
   />
...
7. Click on the **Publish** button to update the embed link with the updated changes in the configurations. The embed link will be copied to your clipboard and is ready to render/embed your circuit. Refer to Figure 2.48.3.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.48.3.png"
     alt="Figure 2.48.3: Publishing the customized project embed"
     caption="Figure 2.48.3: Publishing the customized project embed"
   />
...
8. Paste the iframe code within the HTML frame of the desired webpage.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.48.4.png"
     alt="Figure 2.49: Embedding the CircuitVerse simulation within a webpage"
     caption="Figure 2.49: Embedding the CircuitVerse simulation within a webpage"
   />
...
<OptimizedImage
  src="/img/img_chapter2/2.50.png"
  alt="Figure 2.50: CircuitVerse Chrome Extension for embedding Live Circuit in Google Slides"
  caption="Figure 2.50: CircuitVerse Chrome Extension for embedding Live Circuit in Google Slides"
/>

Watch the below video for a quick demonstration of how the CircuitVerse Chrome extension works in Google Slides.

<div style={{display: "flex", justifyContent: "center"}}><iframe src="https://www.youtube.com/embed/eOf0XAxLz7Y?si=bpX_Po2Sgvihlsiw" style={{width: "80%", aspectRatio: "16/9"}} title="Insert CircuitVerse Live Circuits in Google Slides" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></div>
...
<OptimizedImage
  src="/img/img_chapter2/2.55.png"
  alt="Figure 2.51: Different image formats, views, and resolutions supported within CircuitVerse"
  caption="Figure 2.51: Different image formats, views, and resolutions supported within CircuitVerse"
/>
...
1. Navigate to the circuit design that must be downloaded. Refer to Figure 2.52.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.52.png"
     alt="Figure 2.52: Navigating to the circuit design to be downloaded"
     caption="Figure 2.52: Navigating to the circuit design to be downloaded"
   />
...
2. Click on the **Launch Simulator** button to launch the circuit simulation in the CircuitVerse simulator. Refer to Figure 2.53.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.53.png"
     alt="Figure 2.53: Launching the CircuitVerse simulator for the selected circuit design"
     caption="Figure 2.53: Launching the CircuitVerse simulator for the selected circuit design"
   />
...
3. Click on the **Download Image** icon displayed in the quick access toolbar. Alternatively, you can navigate to the **Tools** drop-down menu available in the menu toolbar and select **Download Image**. Refer to Figure 2.54.
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.54.png"
     alt="Figure 2.54: Download Image option in the CircuitVerse simulator"
     caption="Figure 2.54: Download Image option in the CircuitVerse simulator"
   />
...
4. The **Render Image** pop-up window is displayed (refer to Figure 2.55).
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.55.png"
     alt="Figure 2.55: Render Image pop-up window in the CircuitVerse simulator"
     caption="Figure 2.55: Render Image pop-up window in the CircuitVerse simulator"
   />
...
6. Click on the **Render Circuit Image** button to download the image on your machine. (Refer to Figure 2.56)
   ...
   <OptimizedImage
     src="/img/img_chapter2/2.56.png"
     alt="Figure 2.56: Rendering the circuit image with the selected settings"
     caption="Figure 2.56: Rendering the circuit image with the selected settings"
   />