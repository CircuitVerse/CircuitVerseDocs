...
<OptimizedImage
  src="/img/img_chapter2/2.1.png"
  alt="Figure 2.1: Different options for managing circuit simulation projects within CircuitVerse"
  caption="Figure 2.1: Different options for managing circuit simulation projects within CircuitVerse"
/>
