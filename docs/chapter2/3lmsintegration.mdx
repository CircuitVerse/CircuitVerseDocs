...
description: "LMS Integration page in Chapter 2 of CircuitVerse documentation."
---
...
3. Check the **Integrate with LMS** box.
   ...
   <OptimizedImage
       src="/img/img_chapter2/lms_integration/lms_checkbox.png"
       alt="Integrate with LMS"
       caption="Figure 2.57: Integrate with LMS"
   />
...
5. After successful creation of an assignment, you will be redirected to the Group page and you will see the **Show LMS Credentials** link on the assignment which you have just created.
   ...
   <OptimizedImage
       src="/img/img_chapter2/lms_integration/show_lms_link.png"
       alt="Show LMS Credentials"
       caption="Figure 2.58: Show LMS Credentials"
   />
...
6. Click on the link and you will see the LMS configuration in the pop-up.
   ...
   <OptimizedImage
       src="/img/img_chapter2/lms_integration/tool_key.png"
       alt="Tool Keys"
       caption="Figure 2.59: Tool Keys"
   />
