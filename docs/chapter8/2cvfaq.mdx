...
7. How can I move a wire while laying out complex designs on the Canvas?
   ...
   <OptimizedImage
       src="/img/img_chapter8/8.1.png"
       alt="Figure 8.1"
       caption="Figure 8.1: Moving a wire on the Canvas by selecting both the nodes of the wire"
   />
...
8. I'm getting lots of problems with the new UI now. Is the old CircuitVerse simulator interface still accessible?
   ...
   <OptimizedImage
       src="/img/img_chapter8/8.2.png"
       alt="Figure 8.2"
       caption="Figure 8.2: Accessing the old user interface from the Project drop-down menu in the menu bar"
   />
