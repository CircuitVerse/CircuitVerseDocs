...
<OptimizedImage
  src="/img/img_chapter1/1.4.png"
  alt="Some of the key features of the CircuitVerse simulator"
  caption="Figure 1.4: Some of the key features of the CircuitVerse simulator"
/>
