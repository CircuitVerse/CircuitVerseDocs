...
<OptimizedImage
  src="/img/img_chapter3/3.13.png"
  alt="Properties associated with an AND gate"
  caption="Figure 3.13: Properties associated with an AND gate"
/>
...
<OptimizedImage
  src="/img/img_chapter3/3.14.png"
  alt="Edit Layout button converting the circuit into a black box"
  caption="Figure 3.14: Edit Layout button converting the circuit into a black box"
/>
...
<OptimizedImage
  src="/img/img_chapter3/3.15.png"
  alt="LAYOUT ELEMENTS and LAYOUT panels to edit the circuit layout"
  caption="Figure 3.15: LAYOUT ELEMENTS and LAYOUT panels to edit the circuit layout"
/>
