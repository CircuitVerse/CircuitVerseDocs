...
<OptimizedImage
  src="/img/img_chapter3/3.1.png"
  alt="Different sections of the CircuitVerse simulator"
  caption="Figure 3.1: Different sections of the CircuitVerse simulator"
/>
...
- [Menu Bar](menubar.mdx)
- [Circuit Elements Panel](circuitelements.mdx)
- [Properties Panel](properties.mdx)
- [Circuit Tabs](circuittabs.mdx)
- [Quick Access Panel](quickaccesspanel.mdx)
- [Canvas](canvas.md)
- [Report System](reportsystem.mdx)
- [Multi-bit Wires (Buses)](wires.mdx)
