...
<OptimizedImage
  src="/img/img_chapter3/3.22.png"
  alt="Wires connecting different circuit elements in the CircuitVerse simulator"
  caption="Figure 3.22"
/>
...
<OptimizedImage
  src="/img/img_chapter3/3.23.png"
  alt="Multi-bit wires being used for splitting and combining multi-bit data using splitters"
  caption="Figure 3.23"
/>