...
<OptimizedImage
  src="/img/img_chapter3/3.16.png"
  alt="Error when trying to delete the main circuit without adding any main circuit"
  caption="Figure 3.16"
/>
...
<OptimizedImage
  src="/img/img_chapter3/3.17.png"
  alt="Adding circuit tabs for complex circuit designs"
  caption="Figure 3.17"
/>
...
<OptimizedImage
  src="/img/img_chapter3/3.18.png"
  alt="Circuit drop-down menu to add or insert subcircuits"
  caption="Figure 3.18"
/>
...
<OptimizedImage
  src="/img/img_chapter3/3.19.png"
  alt="Renaming circuit tabs using the PROPERTIES panel"
  caption="Figure 3.19"
/>